...
static void test_alg2201(BOOL8 flag)
{
	...
	if (am_hasWbcMode(nModePara))
	{
		...
		strcpy( plsFile, "E:/Code/Release/XQ100/trunk/build/src/testbench/data/DebugData/01/");
		strcat( plsFile, "20200705_113557-38.wbc.pls");
		do 
		{
			// 从文件读数据
	...
	hgbA		= valueListDP(&featureParas, "HgbAbsorbance");		// HGB吸光度
