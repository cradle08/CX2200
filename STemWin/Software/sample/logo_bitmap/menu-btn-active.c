...
extern GUI_CONST_STORAGE GUI_BITMAP bmmenubtnactive;

static GUI_CONST_STORAGE unsigned short _acmenubtnactive[] = {
...
GUI_CONST_STORAGE GUI_BITMAP bmmenubtnactive = {
  31, // xSize
  14, // ySize
  62, // BytesPerLine
  16, // BitsPerPixel
  (unsigned char *)_acmenubtnactive,  // Pointer to picture data
