...
//  ComSpaceTiming.HoldSetupTime = 3/2;
//  ComSpaceTiming.HiZSetupTime = 3/2;
//  /* AttSpaceTiming */
//  AttSpaceTiming.SetupTime = 3;
//  AttSpaceTiming.WaitSetupTime = 3;
//  AttSpaceTiming.HoldSetupTime = 3/2;
//  AttSpaceTiming.HiZSetupTime = 3/2;
/* USER CODE END 0 */
...
void MX_FMC_Init(void)
{
  ...
  */
  ...
  hnand1.Config.SpareAreaSize = 2048;
  hnand1.Config.BlockSize = 64;
  hnand1.Config.BlockNbr = 64;
  hnand1.Config.PlaneNbr = 2048;
...
static void HAL_FMC_MspInit(void){
  ...
  */
  ...
  /* USER CODE BEGIN FMC_MspInit 1 */
   //修改Nash flash中PD6_R/B， PG9_NCE3引脚定义
  GPIO_InitStruct.Pin = NAND_READY_BUSY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  //GPIO_InitStruct.Alternate = GPIO_AF12_FMC;
  HAL_GPIO_Init(NAND_READY_BUSY_Port, &GPIO_InitStruct); 
