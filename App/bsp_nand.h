...
//#define NAND_TPROG_DELAY			25000       //35*10*200 = 200us 通过循环来延时			
//#define NAND_TBERS_DELAY			20*NAND_TPROG_DELAY			//35*10*200*20 = 4ms 通过循环来延时		
...
typedef struct
{
	...
	uint16_t lut[NAND_MAX_PAGE_SIZE];    //LUT表，用作逻辑块-物理块转换
...
#define NAND_RB  				 HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_6)//PDin(6)	//NAND Flash的闲/忙引脚 
